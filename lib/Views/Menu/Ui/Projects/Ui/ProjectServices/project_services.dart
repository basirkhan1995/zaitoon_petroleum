...
class _DesktopState extends State<_Desktop> {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle? subtitleStyle = Theme.of(context).textTheme.titleSmall?.copyWith(color: color.outline.withValues(alpha: .5));
    return Scaffold(
      body: BlocBuilder<ProjectServicesBloc, ProjectServicesState>(
