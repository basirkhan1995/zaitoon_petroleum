...
class _DesktopState extends State<_Desktop> {
  ...
  void initState() {
    ...
    if (widget.model != null) {
      ...
      city.text = m.city ?? "";
      province.text = m.province ?? "";
      country.text = m.country ?? "";
      zipCode.text = m.zipCode?.toString() ?? "";
      address.text = m.address ?? "";
      gender = m.perGender ?? "Male";
      mailingValue = m.isMailing ?? 1;
  ...
  Widget build(BuildContext context) {
    ...
    return ZFormDialog(
      ...
      title: isEdit ? locale.edit : locale.newKeyword,
  ...
  void onSubmit() {
    ...
    final data = IndividualsModel(
      ...
      perGender: gender,
      perDoB: widget.model?.perDoB ?? "1995/01/01",
